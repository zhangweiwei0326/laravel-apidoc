...
class DocController extends Controller
{
    ...
    public function getList()
    {
        ...
        foreach ($list as $key=>$moudel){
            $list[$key]['iconClose'] = $this->request->root()."/apidoc/js/zTree_v3/img/zt-folder.png";
            $list[$key]['iconOpen'] = $this->request->root()."/apidoc/js/zTree_v3/img/zt-folder-o.png";
            $list[$key]['open'] = true;
            $list[$key]['isParent'] = true;
            foreach ($moudel['actions'] as $k=>$v) {
                $moudel['actions'][$k]['icon'] = $this->request->root()."/apidoc/js/zTree_v3/img/zt-file.png";
